...
class SBAddress(_object):
    ...
    * load addresses
    ...
    def __repr__(self) -> "std::string":
        """__repr__(SBAddress self) -> std::string"""
...
class SBBlock(_object):
    ...
    def __repr__(self) -> "std::string":
        """__repr__(SBBlock self) -> std::string"""
...
class SBBreakpoint(_object):
    ...
    def __repr__(self) -> "std::string":
        """__repr__(SBBreakpoint self) -> std::string"""
...
class SBBreakpointLocation(_object):
    ...
    def __repr__(self) -> "std::string":
        """__repr__(SBBreakpointLocation self) -> std::string"""
...
class SBBreakpointName(_object):
    ...
    def __repr__(self) -> "std::string":
        """__repr__(SBBreakpointName self) -> std::string"""
...
class SBBroadcaster(_object):
    ...
    def RemoveListener(self, listener: 'SBListener', event_mask: 'uint32_t'=4294967295) -> "bool":
        """
...
class SBCommandInterpreter(_object):
    ...
    def UserCommandExists(self, cmd: 'char const *') -> "bool":
    ...
    def SourceInitFileInHomeDirectory(self, *args) -> "void":
        """
    ...
    def AllowExitCodeOnQuit(self, allow: 'bool') -> "void":
...
class SBCommandInterpreterRunOptions(_object):
    ...
    * AddToHistory:   true
    ...
    def __init__(self, *args):
        ...
        __init__(lldb::SBCommandInterpreterRunOptions self, SBCommandInterpreterRunOptions rhs) -> SBCommandInterpreterRunOptions
        """
        this = _lldb.new_SBCommandInterpreterRunOptions(*args)
        try:
            self.this.append(this)
        except __builtin__.Exception:
            self.this = this
    ...
    def SetEchoCommentCommands(self, echo: 'bool') -> "void":
    ...
    def SetAutoHandleEvents(self, arg2: 'bool') -> "void":
    ...
    def SetSpawnThread(self, arg2: 'bool') -> "void":
...
class SBCommandReturnObject(_object):
    ...
    def __repr__(self) -> "std::string":
        """__repr__(SBCommandReturnObject self) -> std::string"""
...
class SBCompileUnit(_object):
    ...
    def FindLineEntryIndex(self, *args) -> "uint32_t":
        ...
        FindLineEntryIndex(SBCompileUnit self, SBLineEntry line_entry) -> uint32_t
    ...
    def __repr__(self) -> "std::string":
        """__repr__(SBCompileUnit self) -> std::string"""
...
class SBData(_object):
    ...
    def GetDescription(self, *args) -> "bool":
        ...
        GetDescription(SBData self, SBStream description) -> bool
        """
    ...
    def __repr__(self) -> "std::string":
        """__repr__(SBData self) -> std::string"""
...
class SBDebugger(_object):
    ...
    def GetProgressDataFromEvent(event: 'SBEvent') -> "lldb::SBStructuredData":
        """GetProgressDataFromEvent(SBEvent event) -> SBStructuredData"""
        return _lldb.SBDebugger_GetProgressDataFromEvent(event)

    GetProgressDataFromEvent = staticmethod(GetProgressDataFromEvent)
    ...
    def PrintDiagnosticsOnError() -> "void":
        """PrintDiagnosticsOnError()"""
        return _lldb.SBDebugger_PrintDiagnosticsOnError()

    PrintDiagnosticsOnError = staticmethod(PrintDiagnosticsOnError)
    ...
    def SkipAppInitFiles(self, b: 'bool') -> "void":
    ...
    def EnableLog(self, channel: 'char const *', categories: 'char const **') -> "bool":
    ...
    def SetDestroyCallback(self, destroy_callback: 'lldb::SBDebuggerDestroyCallback') -> "void":
    ...
    def SetREPLLanguage(self, repl_lang: 'lldb::LanguageType') -> "void":
    ...
    def LoadTraceFromFile(self, error: 'SBError', trace_description_file: 'SBFileSpec') -> "lldb::SBTrace":
    ...
    def __repr__(self) -> "std::string":
        """__repr__(SBDebugger self) -> std::string"""
...
def SBDebugger_GetBroadcasterClass() -> "char const *":
    """SBDebugger_GetBroadcasterClass() -> char const *"""
    return _lldb.SBDebugger_GetBroadcasterClass()
...
def SBDebugger_GetProgressDataFromEvent(event: 'SBEvent') -> "lldb::SBStructuredData":
...
def SBDebugger_PrintDiagnosticsOnError() -> "void":
...
class SBDeclaration(_object):
    ...
    def __repr__(self) -> "std::string":
        """__repr__(SBDeclaration self) -> std::string"""
...
class SBError(_object):
    ...
    def __init__(self, *args):
        ...
        __init__(lldb::SBError self, char const * message) -> SBError
        """
    ...
    def __repr__(self) -> "std::string":
        """__repr__(SBError self) -> std::string"""
...
class SBExpressionOptions(_object):
    ...
    def SetTimeoutInMicroSeconds(self, *args) -> "void":
        """
        SetTimeoutInMicroSeconds(SBExpressionOptions self, uint32_t timeout)
        ...
        """
        return _lldb.SBExpressionOptions_SetTimeoutInMicroSeconds(self, *args)
    ...
    def SetOneThreadTimeoutInMicroSeconds(self, *args) -> "void":
        """
        SetOneThreadTimeoutInMicroSeconds(SBExpressionOptions self, uint32_t timeout)
        ...
        """
        return _lldb.SBExpressionOptions_SetOneThreadTimeoutInMicroSeconds(self, *args)
...
class SBFile(_object):
    ...
    def __init__(self, *args):
        ...
        __init__(lldb::SBFile self, lldb::FileSP file_sp) -> SBFile
...
class SBFileSpec(_object):
    ...
    def __repr__(self) -> "std::string":
        """__repr__(SBFileSpec self) -> std::string"""
...
class SBFrame(_object):
    ...
    def __repr__(self) -> "std::string":
        """__repr__(SBFrame self) -> std::string"""
...
class SBFunction(_object):
    ...
    def __repr__(self) -> "std::string":
        """__repr__(SBFunction self) -> std::string"""
...
class SBHostOS(_object):
    ...
    def ThreadCreate(name: 'char const *', thread_function: 'lldb::thread_func_t', thread_arg: 'void *', err: 'SBError') -> "lldb::thread_t":
...
def SBHostOS_ThreadCreate(name: 'char const *', thread_function: 'lldb::thread_func_t', thread_arg: 'void *', err: 'SBError') -> "lldb::thread_t":
    """SBHostOS_ThreadCreate(char const * name, lldb::thread_func_t thread_function, void * thread_arg, SBError err) -> lldb::thread_t"""
    return _lldb.SBHostOS_ThreadCreate(name, thread_function, thread_arg, err)
...
class SBInstruction(_object):
    ...
    def __repr__(self) -> "std::string":
        """__repr__(SBInstruction self) -> std::string"""
...
class SBInstructionList(_object):
    ...
    def GetInstructionsCount(self, start: 'SBAddress', end: 'SBAddress', canSetBreakpoint: 'bool'=False) -> "size_t":
        ...
        GetInstructionsCount(SBInstructionList self, SBAddress start, SBAddress end) -> size_t
        """
    ...
    def __repr__(self) -> "std::string":
        """__repr__(SBInstructionList self) -> std::string"""
...
class SBLineEntry(_object):
    ...
    def __repr__(self) -> "std::string":
        """__repr__(SBLineEntry self) -> std::string"""
...
class SBListener(_object):
    ...
    def StopListeningForEventClass(self, debugger: 'SBDebugger', broadcaster_class: 'char const *', event_mask: 'uint32_t') -> "bool":
...
class SBMemoryRegionInfo(_object):
    ...
    def __init__(self, *args):
        ...
        __init__(lldb::SBMemoryRegionInfo self, char const * name, lldb::addr_t begin, lldb::addr_t end, uint32_t permissions, bool mapped, bool stack_memory=False) -> SBMemoryRegionInfo
        __init__(lldb::SBMemoryRegionInfo self, char const * name, lldb::addr_t begin, lldb::addr_t end, uint32_t permissions, bool mapped) -> SBMemoryRegionInfo
        """
    ...
    def __repr__(self) -> "std::string":
        """__repr__(SBMemoryRegionInfo self) -> std::string"""
...
class SBModule(_object):
    ...
    def __repr__(self) -> "std::string":
        """__repr__(SBModule self) -> std::string"""
...
class SBModuleSpec(_object):
    ...
    def __repr__(self) -> "std::string":
        """__repr__(SBModuleSpec self) -> std::string"""
...
class SBModuleSpecList(_object):
    ...
    def __repr__(self) -> "std::string":
        """__repr__(SBModuleSpecList self) -> std::string"""
...
class SBPlatformShellCommand(_object):
    ...
    def SetShell(self, shell: 'char const *') -> "void":
...
class SBPlatform(_object):
    ...
    def __init__(self, *args):
        ...
        __init__(lldb::SBPlatform self, char const * platform_name) -> SBPlatform
        __init__(lldb::SBPlatform self, SBPlatform rhs) -> SBPlatform
        """
    ...
    def SetWorkingDirectory(self, path: 'char const *') -> "bool":
...
class SBProcess(_object):
    ...
    def GetQueueAtIndex(self, index: 'size_t') -> "lldb::SBQueue":
    ...
    def Detach(self, *args) -> "lldb::SBError":
        """
    ...
    def LoadImage(self, *args) -> "uint32_t":
        """
    ...
    def SendEventData(self, data: 'char const *') -> "lldb::SBError":
    ...
    def SaveCore(self, *args) -> "lldb::SBError":
        """
    ...
    def __repr__(self) -> "std::string":
        """__repr__(SBProcess self) -> std::string"""
...
class SBQueue(_object):
    ...
    def __init__(self, *args):
        ...
        __init__(lldb::SBQueue self, SBQueue rhs) -> SBQueue
        """
...
class SBScriptObject(_object):
    """Proxy of C++ lldb::SBScriptObject class."""

    __swig_setmethods__ = {}
    __setattr__ = lambda self, name, value: _swig_setattr(self, SBScriptObject, name, value)
    __swig_getmethods__ = {}
    __getattr__ = lambda self, name: _swig_getattr(self, SBScriptObject, name)
    __repr__ = _swig_repr

    def __init__(self, *args):
        """
        __init__(lldb::SBScriptObject self, lldb::ScriptObjectPtr const ptr, lldb::ScriptLanguage lang) -> SBScriptObject
        __init__(lldb::SBScriptObject self, SBScriptObject rhs) -> SBScriptObject
        """
        this = _lldb.new_SBScriptObject(*args)
        try:
            self.this.append(this)
        except __builtin__.Exception:
            self.this = this
...
SBScriptObject_swigregister = _lldb.SBScriptObject_swigregister
SBScriptObject_swigregister(SBScriptObject)
...
class SBSection(_object):
    ...
    def GetAlignment(self) -> "uint32_t":
    ...
    def __repr__(self) -> "std::string":
        """__repr__(SBSection self) -> std::string"""
...
class SBSourceManager(_object):
    ...
    def __init__(self, *args):
        """
        __init__(lldb::SBSourceManager self, SBDebugger debugger) -> SBSourceManager
        __init__(lldb::SBSourceManager self, SBTarget target) -> SBSourceManager
...
class SBStringList(_object):
    ...
    def GetStringAtIndex(self, *args) -> "char const *":
        """
...
class SBStructuredData(_object):
    ...
    def __init__(self, *args):
        ...
        __init__(lldb::SBStructuredData self, SBScriptObject obj, SBDebugger debugger) -> SBStructuredData
        """
    ...
    def GetUnsignedIntegerValue(self, *args) -> "uint64_t":
        """
        GetUnsignedIntegerValue(SBStructuredData self, uint64_t fail_value) -> uint64_t
        GetUnsignedIntegerValue(SBStructuredData self) -> uint64_t
        """
        return _lldb.SBStructuredData_GetUnsignedIntegerValue(self, *args)


    def GetSignedIntegerValue(self, *args) -> "int64_t":
        """
        GetSignedIntegerValue(SBStructuredData self, int64_t fail_value) -> int64_t
        GetSignedIntegerValue(SBStructuredData self) -> int64_t
        """
        return _lldb.SBStructuredData_GetSignedIntegerValue(self, *args)


    def GetIntegerValue(self, *args) -> "uint64_t":
        """
        GetIntegerValue(SBStructuredData self, uint64_t fail_value) -> uint64_t
        GetIntegerValue(SBStructuredData self) -> uint64_t
        """
        return _lldb.SBStructuredData_GetIntegerValue(self, *args)


    def GetFloatValue(self, *args) -> "double":
        """
        GetFloatValue(SBStructuredData self, double fail_value) -> double
        GetFloatValue(SBStructuredData self) -> double
        """
        return _lldb.SBStructuredData_GetFloatValue(self, *args)
...
class SBSymbol(_object):
    ...
    def __repr__(self) -> "std::string":
        """__repr__(SBSymbol self) -> std::string"""
...
class SBSymbolContext(_object):
    ...
    def __repr__(self) -> "std::string":
        """__repr__(SBSymbolContext self) -> std::string"""
...
class SBSymbolContextList(_object):
    ...
    def __repr__(self) -> "std::string":
        """__repr__(SBSymbolContextList self) -> std::string"""
...
class SBTarget(_object):
    ...
    def SetModuleLoadAddress(self, module: 'SBModule', sections_offset: 'uint64_t') -> "lldb::SBError":
    ...
    def BreakpointCreateBySBAddress(self, address: 'SBAddress') -> "lldb::SBBreakpoint":
    ...
    def __repr__(self) -> "std::string":
        """__repr__(SBTarget self) -> std::string"""
...
class SBThread(_object):
    ...
    def StepInto(self, *args) -> "void":
        ...
        StepInto(SBThread self, char const * target_name, uint32_t end_line, SBError error, lldb::RunMode stop_other_threads)
        StepInto(SBThread self, char const * target_name, uint32_t end_line, SBError error)
    ...
    def __repr__(self) -> "std::string":
        """__repr__(SBThread self) -> std::string"""
...
class SBThreadPlan(_object):
    ...
    def __init__(self, *args):
        ...
        __init__(lldb::SBThreadPlan self, SBThread thread, char const * class_name, SBStructuredData args_data) -> SBThreadPlan
        """
    ...
    def QueueThreadPlanForStepOverRange(self, *args) -> "lldb::SBThreadPlan":
        """
    ...
    def QueueThreadPlanForStepInRange(self, *args) -> "lldb::SBThreadPlan":
        """
    ...
    def QueueThreadPlanForStepOut(self, *args) -> "lldb::SBThreadPlan":
        """
    ...
    def QueueThreadPlanForRunToAddress(self, *args) -> "lldb::SBThreadPlan":
        """
...
class SBTrace(_object):
    ...
    def LoadTraceFromFile(error: 'SBError', debugger: 'SBDebugger', trace_description_file: 'SBFileSpec') -> "lldb::SBTrace":
    ...
    LoadTraceFromFile = staticmethod(LoadTraceFromFile)
    ...
    def SaveToDisk(self, error: 'SBError', bundle_dir: 'SBFileSpec', compact: 'bool'=False) -> "lldb::SBFileSpec":
        """
        SaveToDisk(SBTrace self, SBError error, SBFileSpec bundle_dir, bool compact=False) -> SBFileSpec
        SaveToDisk(SBTrace self, SBError error, SBFileSpec bundle_dir) -> SBFileSpec
        """
...
def SBTrace_LoadTraceFromFile(error: 'SBError', debugger: 'SBDebugger', trace_description_file: 'SBFileSpec') -> "lldb::SBTrace":
    """SBTrace_LoadTraceFromFile(SBError error, SBDebugger debugger, SBFileSpec trace_description_file) -> SBTrace"""
    return _lldb.SBTrace_LoadTraceFromFile(error, debugger, trace_description_file)
...
class SBTypeMember(_object):
    ...
    def __repr__(self) -> "std::string":
        """__repr__(SBTypeMember self) -> std::string"""
...
class SBTypeMemberFunction(_object):
    ...
    def __repr__(self) -> "std::string":
        """__repr__(SBTypeMemberFunction self) -> std::string"""
...
class SBTypeList(_object):
    ...
    def __init__(self, *args):
        ...
        __init__(lldb::SBTypeList self, SBTypeList rhs) -> SBTypeList
        """
        this = _lldb.new_SBTypeList(*args)
        try:
            self.this.append(this)
        except __builtin__.Exception:
            self.this = this
...
class SBTypeCategory(_object):
    ...
    def __repr__(self) -> "std::string":
        """__repr__(SBTypeCategory self) -> std::string"""
...
class SBTypeEnumMember(_object):
    ...
    def __repr__(self) -> "std::string":
        """__repr__(SBTypeEnumMember self) -> std::string"""
...
class SBTypeFilter(_object):
    ...
    def __repr__(self) -> "std::string":
        """__repr__(SBTypeFilter self) -> std::string"""
...
class SBTypeFormat(_object):
    ...
    def __init__(self, *args):
        ...
        __init__(lldb::SBTypeFormat self, lldb::Format format, uint32_t options) -> SBTypeFormat
        __init__(lldb::SBTypeFormat self, lldb::Format format) -> SBTypeFormat
        __init__(lldb::SBTypeFormat self, char const * type, uint32_t options) -> SBTypeFormat
    ...
    def __repr__(self) -> "std::string":
        """__repr__(SBTypeFormat self) -> std::string"""
...
class SBTypeNameSpecifier(_object):
    ...
    def __repr__(self) -> "std::string":
        """__repr__(SBTypeNameSpecifier self) -> std::string"""
...
class SBTypeSummary(_object):
    ...
    def CreateWithSummaryString(*args) -> "lldb::SBTypeSummary":
        """
        CreateWithSummaryString(char const * data, uint32_t options) -> SBTypeSummary
    ...
    def CreateWithFunctionName(*args) -> "lldb::SBTypeSummary":
        """
        CreateWithFunctionName(char const * data, uint32_t options) -> SBTypeSummary
    ...
    def CreateWithScriptCode(*args) -> "lldb::SBTypeSummary":
        """
        CreateWithScriptCode(char const * data, uint32_t options) -> SBTypeSummary
    ...
    def __repr__(self) -> "std::string":
        """__repr__(SBTypeSummary self) -> std::string"""
...
def SBTypeSummary_CreateWithSummaryString(*args) -> "lldb::SBTypeSummary":
    """
    CreateWithSummaryString(char const * data, uint32_t options) -> SBTypeSummary
...
def SBTypeSummary_CreateWithFunctionName(*args) -> "lldb::SBTypeSummary":
    """
    CreateWithFunctionName(char const * data, uint32_t options) -> SBTypeSummary
...
def SBTypeSummary_CreateWithScriptCode(*args) -> "lldb::SBTypeSummary":
    """
    CreateWithScriptCode(char const * data, uint32_t options) -> SBTypeSummary
...
class SBTypeSynthetic(_object):
    ...
    def CreateWithClassName(*args) -> "lldb::SBTypeSynthetic":
        """
        CreateWithClassName(char const * data, uint32_t options) -> SBTypeSynthetic
    ...
    def CreateWithScriptCode(*args) -> "lldb::SBTypeSynthetic":
        """
        CreateWithScriptCode(char const * data, uint32_t options) -> SBTypeSynthetic
    ...
    def __repr__(self) -> "std::string":
        """__repr__(SBTypeSynthetic self) -> std::string"""
...
def SBTypeSynthetic_CreateWithClassName(*args) -> "lldb::SBTypeSynthetic":
    """
    CreateWithClassName(char const * data, uint32_t options) -> SBTypeSynthetic
...
def SBTypeSynthetic_CreateWithScriptCode(*args) -> "lldb::SBTypeSynthetic":
    """
    CreateWithScriptCode(char const * data, uint32_t options) -> SBTypeSynthetic
...
class SBValue(_object):
    ...
    def GetValueAsSigned(self, *args) -> "int64_t":
        """
        GetValueAsSigned(SBValue self, SBError error, int64_t fail_value) -> int64_t
        GetValueAsSigned(SBValue self, SBError error) -> int64_t
        GetValueAsSigned(SBValue self, int64_t fail_value) -> int64_t
    ...
    def GetValueAsUnsigned(self, *args) -> "uint64_t":
        """
        GetValueAsUnsigned(SBValue self, SBError error, uint64_t fail_value) -> uint64_t
        GetValueAsUnsigned(SBValue self, SBError error) -> uint64_t
        GetValueAsUnsigned(SBValue self, uint64_t fail_value) -> uint64_t
    ...
    def GetPointeeData(self, *args) -> "lldb::SBData":
        """
        GetPointeeData(SBValue self, uint32_t item_idx, uint32_t item_count) -> SBData
        GetPointeeData(SBValue self, uint32_t item_idx) -> SBData
        ...
        """
        return _lldb.SBValue_GetPointeeData(self, *args)
    ...
    def Watch(self, *args) -> "lldb::SBWatchpoint":
        """
    ...
    def __repr__(self) -> "std::string":
        """__repr__(SBValue self) -> std::string"""
...
class SBWatchpoint(_object):
    ...
    def GetWatchSpec(self) -> "char const *":
        """
    ...
    def __repr__(self) -> "std::string":
        """__repr__(SBWatchpoint self) -> std::string"""
